...
const About = () => {
  return (
    <section
      className="relative flex w-full items-center justify-center px-4 pt-28 pb-8"
      id="about"
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-4xl">
        <article className="rounded-[2rem] border p-3 md:p-4" style={{ backgroundColor: "oklch(var(--muted) / 0.38)", borderColor: "oklch(var(--border))" }}>
          ...
          >
            <div className="mb-4 flex items-center justify-end gap-2" aria-hidden="true">
              <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "oklch(var(--muted-foreground))" }} />
              <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "oklch(var(--muted-foreground) / 0.8)" }} />
              <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "oklch(var(--muted-foreground) / 0.6)" }} />
            </div>
            ...
            <div className="space-y-2 font-mono text-sm">
              ...
              <p>
                <span style={{ color: "oklch(var(--muted-foreground))" }}>$</span> cat blogs.md
              </p>
